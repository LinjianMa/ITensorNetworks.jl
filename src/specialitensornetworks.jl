...
function randomITensorNetwork(
  s::IndsNetwork; link_space=nothing, distribution=Normal{Float64}()
)
...
@traitfn function randomITensorNetwork(
  g::::IsUnderlyingGraph; link_space=nothing, distribution=Normal{Float64}()
)
...
function randomITensorNetwork(eltype::Type, s::IndsNetwork; link_space=nothing)
  return randomITensorNetwork(s; link_space=link_space, distribution=Normal{eltype}())
end

@traitfn function randomITensorNetwork(
  eltype::Type, g::::IsUnderlyingGraph; link_space=nothing
)
  return randomITensorNetwork(g; link_space=link_space, distribution=Normal{eltype}())
end
